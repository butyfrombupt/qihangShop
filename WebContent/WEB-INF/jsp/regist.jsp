...
function change(){
	...
	checkimg1.src="${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();
}
	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src=" ${pageContext.request.contextPath}/image/qihang1.jpg" alt="传智播客">
			</a>
		</div>
	</div>
	<div class="span9">
